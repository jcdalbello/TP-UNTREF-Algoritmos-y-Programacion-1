...
public class Boton extends Actor {
    ...
    // Agregadas para ver si se al ser accesibles es posible facilitar el tema de seleccionar un objetivo
    public boolean puedeAtacarlo(Criatura otro) {
        return this.onClick.puedeAtacarlo(otro);
    }
    
    public void atacar(Criatura otro) {
        this.onClick.atacar(otro);
    }

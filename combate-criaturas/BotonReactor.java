...
public class BotonReactor {
    ...
    public boolean puedeAtacarlo(Criatura otro) {
        ...
        case 1:
            return this.criaturaActual.puedeRealizarAtaque1En(otro) && otro.getVida() > 0;
        case 2:
            return this.criaturaActual.puedeRealizarAtaque2En(otro) && otro.getVida() > 0;
        case 3:
            return this.criaturaActual.puedeRealizarAtaque3En(otro) && otro.getVida() > 0;
        case 4:
            return this.criaturaActual.puedeRealizarAtaque4En(otro) && otro.getVida() > 0;
        }
